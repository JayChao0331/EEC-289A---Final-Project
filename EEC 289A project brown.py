...
for grum in n_minus_1:
    # Input text for trigram prediction
    input_text = grum  # Change as needed
...
#avg_entropy_brown = torch.mean(tensor_entropies)

avg_entropy_brown = 0
i = 0
for weight in weighted_grams.values():
    avg_entropy_brown += weight*entropies[i]
    i+=1

print(avg_entropy_brown)